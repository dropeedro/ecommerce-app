...
export const commit = asyncHandler(async function (request, response, next) {
  //Flujos:
...
export const status = asyncHandler(async function (request, response, next) {
...
export const refund = asyncHandler(async function (request, response, next) {
